        ...
        <div class="row">
          <card class="card-signup" header-classes="text-center" color="orange">
            ...
            <div class="text-center">
              <n-button type="neutral" round size="lg" v-bind:disabled="verifyDisabled"
              id="sendbtn" @click="handleSendVerify()">注 册</n-button>
            </div>
            <td>
            <fg-input
                class="no-border"
            ...
            <td>
                ...
                type="neutral" round @click="handleSignUp()"
                >验证个人身份</n-button>
              </td>

            <div class="">
                <a class="btn btn-simple btn-link"
                @click="toLogin()">已有账户，去登录 >>></a>
